...
public class VectorQuantizer extends Algorithm{
    ...
    public void Compression(String FileName, int codeBookLength, int vectRows) throws IOException {
        ReadWriteImage newReader = new ReadWriteImage();
        Files x = new Files();
    ...
    public void Decompression(String fileName, int vectRows) throws FileNotFoundException, IOException {
        ReadWriteImage newWriter = new ReadWriteImage(512 , 512);
        Files x = new Files();
...
// Find Avarage of blocks and split this avargae block into blocks and find nearest vectors
    ...
    public void compress(File inputFile, File outputFile) {
        try {
            this.Compression(inputFile.toString(), 16, 8);
        } catch (IOException e) {
    ...
    public void decompress(File inputFile, File outputFile) {
        try {
            this.Decompression(inputFile.toString(), 8);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
